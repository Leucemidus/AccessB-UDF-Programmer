    ...
    public class AccessB : winusbapi
    {
        ...
        */
        ...
        public bool PROGRAM_UDF(ulong StartAddress, byte[] ProgramData)
        {
            ...
            if (StartAddress < 0x4280)
            {
                //The PIC firmware include another Flash program lock if the user want to write outside the UDF PIC memory range.
                MessageBox.Show("StartAddress: " + StartAddress.ToString() + " is outside the UDF Flash program memory range. Range of UDF is 0x4280 - 0x7FFF (17024 - 32767)");
                return false;
            }
            ...
            string Address = "4280";     //HARDCODED. From this Address start the UDF in the 18F2550 flash program memory
